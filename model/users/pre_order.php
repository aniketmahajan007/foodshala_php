...
# Fetching previous order of users
$nums=$conn->prepare("SELECT o.order_id,o.order_date,o.tot_price,r.res_logo,r.res_name,r.res_description FROM orders o,restaurant r WHERE o.cust_id=? AND o.res_id=r.res_id");
